...
namespace LivecoinWrapper
{
    public sealed class LiveClientPrivate : LiveClient
    {
        ...
        public async Task<List<PrivateTrade>> ReturnTradeHistoryAsync(string pairId = null, bool orderDesc = true, ushort limit = _min, ushort offset = _i_null) =>
        ...
        public async Task<Orders> ReturnOrdersAsync(string pairId = null, string status = _all, ulong? issuedFrom = null, ulong? issuedTo = null, uint startRow = _i_null, uint endRow = _max) =>
        ...
        public async Task<List<Transaction>> ReturnTransactionsAsync(ulong startTime, ulong endTime, string type = _all, ushort resLimit = _min, ushort offset = _i_null) =>
        ...
        public async Task<PlaceOrder> PlaceOrderAsync(string type, string pairId, decimal quantity, decimal price = _d_null) =>
